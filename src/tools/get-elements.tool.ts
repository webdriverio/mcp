...
export const getElementsToolDefinition: ToolDefinition = {
  ...
  inputSchema: {
    ...
    includeContainers: coerceBoolean.optional().default(false).describe('Include non-interactable elements (mobile: all visible elements; UI5: all rendered controls, not only interactable ones). No effect on plain web sessions (default: false)'),
